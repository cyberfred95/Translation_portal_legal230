...
from .views import SingleGlossaryView, AddGlossaryView, UserGlossariesView, GlossariesListAPIView, GetDefaultGlossaryView
...
urlpatterns = [
    ...
    path('api/default_glossary/<str:domain_name>/', login_required(GetDefaultGlossaryView.as_view()), name='get_default_glossary')
]
