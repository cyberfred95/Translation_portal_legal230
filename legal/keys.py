...
MS_ACCESS_TOKEN = 'REMOVED_AZURE_KEY_1'
LEGAL230_STORAGE = 'legal230storage'
MS_CONNECTION = f'DefaultEndpointsProtocol=https;AccountName={LEGAL230_STORAGE};AccountKey={MS_ACCESS_TOKEN};EndpointSuffix=core.windows.net'
