...
from .views import TranslateView, expert_revision, expert_revision_file, ProjectsHistoryView, UsageView, SingleProjectView, \
...
urlpatterns = i18n_patterns(
    ...
    path('usage/', login_required(UsageView.as_view()), name='usage_history'),
