                ...
                const removeBtn = $('<span>')
                    .append(
                        $('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer ml-2.5 text-black flex items-center">' +
                            '<path d="M0.947952 9.93744C0.70278 9.9517 0.461663 9.87019 0.275444 9.71011C-0.0918148 9.34067 -0.0918148 8.74399 0.275444 8.37455L8.31722 0.332744C8.6992 -0.0246894 9.29859 -0.00481991 9.65603 0.377162C9.97924 0.722587 9.99808 1.25351 9.70013 1.62096L1.61098 9.71011C1.42716 9.86788 1.18991 9.94923 0.947952 9.93744Z" fill="#0F3144"/>' +
                            '<path d="M8.98023 9.93746C8.73175 9.9364 8.4936 9.83777 8.31717 9.66278L0.275368 1.62095C-0.0648786 1.22362 -0.0186203 0.625662 0.378708 0.285384C0.733335 -0.0183051 1.25634 -0.0183051 1.61093 0.285384L9.70009 8.32719C10.082 8.68472 10.1017 9.28414 9.74419 9.66603C9.72997 9.68122 9.71528 9.69591 9.70009 9.71013C9.50201 9.88238 9.24134 9.9647 8.98023 9.93746Z" fill="#0F3144"/>' +
                            '</svg>')
                    )
                    .on('click', function () {
